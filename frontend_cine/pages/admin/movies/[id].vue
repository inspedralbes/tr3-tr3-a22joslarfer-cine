<template>
    <div v-if="isAdmin && !isLoading">
        ...
        <button type="submit" class="button--edit" @click="submitFormUpdateMovie()">EDIT</button>
...
export default {
    data() {
        return {
            movie: [],
            url_movie: `http://a22joslarfer/laravel/public/api/movies/${this.$route.params.id}`,
            url_movie_update: `http://a22joslarfer/laravel/public/api/movies/${this.$route.params.id}`,
            isAdmin: false,
            isLoading: true,
        }
    },
